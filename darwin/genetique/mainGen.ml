...
let main () =
  let rec mainLoop popu nbreGen =
    ...
    let popu2 = Selection.get_meilleurs popu1 in (* popu2 garde les meilleurs individus ; c'est là que se passent les affrontements *)
    ...
    let popu5 = Selection.get_prochaine_generation popu1 popu4 in (* on garde parmi la population initiale (popu1) et les nouveaux mutants recombinés (popu4) certains individus pour la prochaine génération *)
